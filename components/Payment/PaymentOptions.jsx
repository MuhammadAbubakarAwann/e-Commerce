...
const PaymentMethod = () => {
  ...
  return (
    <div className="container mx-auto p-6 mt-11 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-6">
        <div className="flex items-center mb-4">
          ...
          >
            <img src={cashOnDeliveryIcon} alt="Cash on Delivery" className="h-10 mr-2" />
            Cash on Delivery
          </label>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="paypal" className="flex items-center cursor-pointer">
              <img src={paypalIcon} alt="PayPal" className="h-12" />
            </label>
          </div>
